...
function gadgets() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, productsArray, container, divItem, i, products, productImage, productTitle, productInfo, productLink, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("https://api.slingacademy.com/v1/sample-data/photos")];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    data = _a.sent();
                    productsArray = data.photos;
